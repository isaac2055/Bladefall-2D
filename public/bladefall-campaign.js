(function installBladefallCampaign(root) {
  ...
  const stages = [
    ...
    { name: 'Frost Sorcerer', len: 8100, theme: 'frost', sky: '#10202c', ground: '#1e3340', grunts: 1, flyers: 1, mix: { frostling: 1 }, type: 'miniboss', boss: 'sorcerer' },
  ...
  const details = [
    ...
    },
    {
      id: 'frost-sorcerer',
      source: 'procedural',
      systems: ['spell-capture', 'moving-siphon', 'water', 'chasing-boss'],
      signature: 'Stay mobile and time three stolen spells through an oscillating siphon.',
      acts: ['frozen route', 'current crossing', 'moving-siphon arena'],
      composition: { recipe: 'current-updraft', at: 0.46 },
      cadence: { adds: 2, foes: ['frostling', 'rifthound', 'stormmote'], accents: [] },
    },
    {
      id: 'emberdeep',
      source: 'procedural',
