(function installBladefallQuests(root) {
  ...
  const questRecords = [
    ...
    },
    {
      ...
      intro: 'Oren asks you to release the two safety catches in the Drop Yard. The second catch secures the gate open.',
      objectives: [
      ...
      reward: { gold: 160 },
      dialogue: {
        offer: 'The yard keeps repeating the same bad fall. Two safety catches still hold—one before the hoist, one beyond it. Loose both and the gate will hold.',
        active: 'Both catches are in the Drop Yard, on this side of the gate. The chain will keep counting until both let go.',
        turnIn: 'Both catches are loose. The gate is secured—keep moving.',
        complete: 'The repaired chain remembers your measure. You will not have to wake the hoist again.',
      },
    },
    {
      ...
      intro: 'Daro asks you to look for the command token carried into the upper watchworks.',
      objectives: [
      ...
      reward: { gold: 180 },
      dialogue: {
        offer: 'Someone carried a watch token east and never came back. If the upper works still hold it, bring it to me.',
        active: 'The token went beyond the old mantlets. I cannot follow that road anymore.',
        turnIn: 'So the watch still obeys a dead command. Keep the road it opened; I have no wish to wear that face again.',
        complete: 'You brought back more than brass. The watch finally knows its command is over.',
      },
    },
  ];
