(function(root,factory){
  ...
  const ENTRIES=Object.freeze({
    ...
    'outskirts.mara.ask':{level:0,type:'npc',speaker:'Mara',text:'Three survey bearings mark the old road: ash by my camp, glass on the upper path, and iron beyond the broken platforms. Set all three so I can prove the tunnel still reaches Black Woods.'},
    'outskirts.mara.progress':{level:0,type:'npc',speaker:'Mara',text:'The road needs all three bearings aligned: ash, glass, and iron.'},
    'outskirts.mara.done':{level:0,type:'npc',speaker:'Mara',text:'All three agree. The tunnel is real, and now I can draw you a map that will survive the dream.'},
    'outskirts.vey.before':{level:0,type:'npc',speaker:'Vey',text:'“You have no weapon. Stay out of a patrol’s reach and jump past when it turns.”'},
    'outskirts.vey.after':{level:0,type:'npc',speaker:'Vey',text:'“You found a weapon. The sealed vigil east of camp may answer it.”'},
    'outskirts.olan.first':{level:0,type:'npc',speaker:'Olan',text:'“The upper path is shorter and holds the GLASS stake. The lower path has safer landings.”'},
    'outskirts.olan.revisit':{level:0,type:'npc',speaker:'Olan',text:'“Both paths rejoin at the signal mast. The high path asks for precision, not a new ability.”'},
    'outskirts.olan.muster':{level:0,type:'npc',speaker:'Olan',text:'“Posts that stood empty all morning are manned. I did not see anyone arrive. The milekeeper’s reserve is above the first stretch of Hollow Mile; its release lowers the road bridges.”'},
    ...
    'causeway.oren.first':{level:2,type:'npc',speaker:'Oren',text:'“That Drop Yard gate bars the road. Both safety catches are on this side—one before the hoist, one beyond it. Stand beside each handle and press Up to release it; then return to me.”'},
    'causeway.oren.revisit':{level:2,type:'npc',speaker:'Oren',text:'“Find both catches in the Drop Yard. The gate will not hold until both are released.”'},
    'causeway.oren.muster':{level:2,type:'npc',speaker:'Oren',text:'“The chain counted again last night. Every link answered, and I never pulled it. The reserve on the camp’s high bracket holds a spare seal and the service-span release.”'},
