(function installBladefallEcology(root) {
  ...
  const SPECIES = Object.freeze({
    ...
    outrider: row('charger', 'ground', ['road', 'camp'], 1.7, 'iron'),
    canopywing: row('harrier', 'air', ['forest', 'high-perch'], 1.8, 'weave'),
    chainmarshal: row('guardian', 'ground', ['road', 'causeway'], 2.4, 'iron'),
    signaler: row('controller', 'ground', ['road', 'ruin', 'settlement'], 1.5, 'weave'),
